...
describe('<ChatMessages />', () => {
    ...
    test('scrolls down to the bottom after messages update', async () => {
        const scrollToMock = vi.fn(); // Mock o Espía nos informa sobre las veces o características con las que ha sido invocada

        //        console.log(wrapper.vm.$refs.chatRef); Para detectar el elemento que queremos probar
